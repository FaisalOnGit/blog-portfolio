...
import portraitImage from '@/images/asli.png'
          ...
          <div className="hidden font-poppins lg:col-span-5 lg:block lg:pl-10">
            <div className="flex justify-center">
              <ul role="list" className="space-y-6">
                <SocialLink
                  href="https://www.instagram.com/faisal_rahman_23/"
                  icon={BsInstagram}
                  className=""
                >
                  faisal_rahman_23
                ...
                <SocialLink
                  href="https://github.com/FaisalOnGit"
                  icon={BsGithub}
                  className=""
                >
                  FaisalOnGit
                ...
                <SocialLink
                  href="https://www.linkedin.com/in/faisal-rahman-1a38a3180/"
                  icon={FaLinkedinIn}
                  className=""
                >
                  Faisal Rahman
